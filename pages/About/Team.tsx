        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          <div className="group">
             <div className="rounded-xl overflow-hidden mb-4 h-64 shadow-md">
                <img src="https://picsum.photos/seed/engineer/600/800" alt="Engineering" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
             </div>
          ...
          <div className="group">
             <div className="rounded-xl overflow-hidden mb-4 h-64 shadow-md">
                <img src="https://picsum.photos/seed/quality/600/800" alt="Quality" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
             </div>
             <div className="bg-slate-50 p-6 rounded-lg text-center relative -mt-12 mx-4 shadow-lg border border-slate-100">
                <div className="mx-auto bg-white p-3 rounded-full w-fit -mt-10 mb-2 shadow-sm text-brand ring-4 ring-slate-50">
          ...
          <div className="group">
             <div className="rounded-xl overflow-hidden mb-4 h-64 shadow-md">
                <img src="https://picsum.photos/seed/ops/600/800" alt="Operations" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
             </div>
             <div className="bg-slate-50 p-6 rounded-lg text-center relative -mt-12 mx-4 shadow-lg border border-slate-100">
                <div className="mx-auto bg-white p-3 rounded-full w-fit -mt-10 mb-2 shadow-sm text-brand ring-4 ring-slate-50">
                  <Box size={24} />
          ...
          <div className="group">
             <div className="rounded-xl overflow-hidden mb-4 h-64 shadow-md">
                <img src="https://picsum.photos/seed/sales/600/800" alt="Sales" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
             </div>
             <div className="bg-slate-50 p-6 rounded-lg text-center relative -mt-12 mx-4 shadow-lg border border-slate-100">
                <div className="mx-auto bg-white p-3 rounded-full w-fit -mt-10 mb-2 shadow-sm text-brand ring-4 ring-slate-50">
                  <Users size={24} />
