            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3">
              {primaryUsesModal ? (
                ...
                isExternalLink(content.primaryCta.href) ? (
                  ...
                  <Link to={content.primaryCta.href} className="flex-1 bg-brand text-ink font-semibold py-3 rounded-full text-center">
                    {content.primaryCta.label}
                  </Link>
                )
              ) : (
              ...
              {secondaryUsesModal ? (
                ...
                isExternalLink(content.secondaryCta.href) ? (
                  ...
                  <Link to={content.secondaryCta.href} className="flex-1 bg-slate-900 text-white font-semibold py-3 rounded-full text-center">
                    {content.secondaryCta.label}
                  </Link>
                )
              ) : (
