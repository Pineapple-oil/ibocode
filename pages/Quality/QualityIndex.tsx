        ...
        <Section light>
            <div className="grid md:grid-cols-3 gap-8">
                 {content.cards.map((card, index) => {
                   ...
                   return (
                     <Link key={`${card.title}-${index}`} to={card.href} className="block bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all group">
