            ...
            <Section light>
                <div className="grid lg:grid-cols-2 gap-12 mb-16 items-start">
                    ...
                    <div className="grid gap-4">
                        <img src="/images/factory_floor_main.png" alt="Factory Floor" className="rounded-xl shadow-lg w-full h-64 object-cover" />
                        <div className="grid grid-cols-2 gap-4">
                            <img src="/images/factory_assembly.png" alt="Assembly" className="rounded-xl shadow-md w-full h-40 object-cover" />
                            <img src="/images/factory_testing.png" alt="Testing" className="rounded-xl shadow-md w-full h-40 object-cover" />
                        </div>
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <img src="/images/factory_packing.png" alt="Packing" className="rounded-xl shadow-lg w-full h-64 object-cover" />
                </div>
