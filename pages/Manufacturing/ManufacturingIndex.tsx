      ...
      <Section light>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          {content.capabilities.cards.map((card, index) => {
            ...
            return (
              <Link key={`${card.title}-${index}`} to={card.href} className="group block bg-white border border-slate-200 rounded-2xl overflow-hidden hover:shadow-xl transition-all">
